...
export type ProjectNextFieldType =
  /** Assignees */
  | 'ASSIGNEES'
  /** Date */
  | 'DATE'
...
export type ProjectNextOrderField =
...
export type ContributionsQuery = { user?: { repositoriesContributedTo: { totalCount: number, nodes?: Array<{ description?: string | undefined, name: string, homepageUrl?: any | undefined, isPrivate: boolean, openGraphImageUrl: any, url: any, id: string } | undefined> | undefined } } | undefined };
 ...
 * @example
 * mockContributionsQuery((req, res, ctx) => {
 ...
 * })
 */
export const mockContributionsQuery = (resolver: ResponseResolver<GraphQLRequest<ContributionsQueryVariables>, GraphQLContext<ContributionsQuery>, any>) =>
  graphql.query<ContributionsQuery, ContributionsQueryVariables>(
    'contributions',
    resolver
  )
...
export const useContributionsQuery = <
      TData = ContributionsQuery,
      TError = unknown
    >(
      client: GraphQLClient,
      variables: ContributionsQueryVariables,
      options?: UseQueryOptions<ContributionsQuery, TError, TData>,
      headers?: RequestInit['headers']
    ) =>
    useQuery<ContributionsQuery, TError, TData>(
      ['contributions', variables],
      fetcher<ContributionsQuery, ContributionsQueryVariables>(client, ContributionsDocument, variables, headers),
      options
    );

useContributionsQuery.getKey = (variables: ContributionsQueryVariables) => ['contributions', variables];
;

useContributionsQuery.fetcher = (client: GraphQLClient, variables: ContributionsQueryVariables, headers?: RequestInit['headers']) => fetcher<ContributionsQuery, ContributionsQueryVariables>(client, ContributionsDocument, variables, headers);